...
*/
template<typename T, unsigned M, unsigned M_CHUNK, unsigned N, unsigned N_CHUNK>
__global__ void transpose(T out[M / M_CHUNK][N / N_CHUNK][COMPLEX][M_CHUNK][N_CHUNK], const T in[COMPLEX][M][N]) {
