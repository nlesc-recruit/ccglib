...
#pragma unroll
  while (bytes_to_go >= sizeof(int4)) {
    ...
    cuda::memcpy_async(&((int4 *)dest)[tid], &((const int4 *)src)[tid], shape, pipe);
  ...
  if (bytes_to_go >= sizeof(int2)) {
    ...
    cuda::memcpy_async(&((int2 *)dest)[tid], &((const int2 *)src)[tid], shape, pipe);
  ...
  if (bytes_to_go >= sizeof(int)) {
    ...
    cuda::memcpy_async(&((int *)dest)[tid], &((const int *)src)[tid], shape, pipe);
  ...
  if (bytes_to_go >= sizeof(short)) {
    ...
    cuda::memcpy_async(&((short *)dest)[tid], &((const short *)src)[tid], shape, pipe);
  ...
  if (bytes_to_go >= sizeof(char)) {
    ...
    cuda::memcpy_async(&((char *)dest)[tid], &((const char *)src)[tid], shape, pipe);
